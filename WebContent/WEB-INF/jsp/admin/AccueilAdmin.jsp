<%@ include file="../../jspf/haut.frag" %>
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
        		...
        		<h4>Résultats trouvé(s) <span class="badge badge-default badge-pill">${fn:length(listeResidents)}</span></h4><br />
    					...
    					<c:forEach var="personne" items="${requestScope['listeResidents']}">
    						<c:choose>
    							...
    							<c:otherwise>
	    							...
	    							<td>${personne.tel}</td>
	    							<td>${personne.appartement.batiment.adresse}, étage ${personne.appartement.etage}, porte ${personne.appartement.porte}</td>
